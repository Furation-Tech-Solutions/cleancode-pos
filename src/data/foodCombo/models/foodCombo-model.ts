...
const foodComboSchema = new mongoose.Schema({
  ...
  // food_menu: [{ food_item: { type: mongoose.Schema.Types.ObjectId, ref: "FoodMenu", required: [true, "Please enter a food menu item"] }, quantity: { type: Number, min: [1, "Quantity should be at least 1"], max: [10, "Maximum quantity is 10"], required: [true, "Please enter a quantity"] } }],
