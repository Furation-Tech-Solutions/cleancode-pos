...
const invoiceSchema = new mongoose.Schema({
  ...
  // invertory_id: [{ type: mongoose.Schema.Types.ObjectId, required: true, ref: 'Invertory' }],
  dateTime: { type: Date, default: Date.now },
  // items: [{ type: mongoose.Schema.Types.ObjectId, required: true, ref: 'Inventory_item' }],
