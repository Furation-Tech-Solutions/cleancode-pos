...
export class SupplierService {
  ...
  async createSupplier(req: Request, res: Response): Promise<void> {
      ...
      const newSupplier: Either<ErrorClass, SupplierEntity> = await this.createSupplierUsecase.execute(
        supplierData
      );
  ...
  async deleteSupplier(req: Request, res: Response): Promise<void> {
      ...
      const updatedSupplier: Either<ErrorClass, SupplierEntity> = await this.updateSupplierUsecase.execute(
        supplierId,
  ...
  async getSupplierById(req: Request, res: Response): Promise<void> {
      ...
      const supplier: Either<ErrorClass, SupplierEntity | null> = await this.getSupplierByIdUsecase.execute(
        supplierId
      );
